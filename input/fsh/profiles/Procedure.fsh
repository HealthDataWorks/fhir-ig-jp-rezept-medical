...
* extension contains
    JpRezeptExtensionProcedureQuantity named quantity 0..* MS and
    JpRezeptExtensionProcedureNumberOfTimes named numberOfTimes 0..* MS and
    JpRezeptExtensionProcedureAddition named addition 0..* MS
