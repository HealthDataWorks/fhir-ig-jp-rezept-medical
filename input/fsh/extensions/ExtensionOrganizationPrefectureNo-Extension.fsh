...
* ^url = "https://igs.healthdataworks.net/jp-rezept-medication/StructureDefinition-JP-REZEPT-ExtensionOrganizationPrefectureNo"
* ^kind = #resource
...
* . ^short = "都道府県番号"
* . ^definition = "都道府県番号です。"
* url = "https://igs.healthdataworks.net/jp-rezept-medication/StructureDefinition-JP-REZEPT-ExtensionOrganizationPrefectureNo" (exactly)
* url MS
